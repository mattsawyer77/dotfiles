...
;; attempting to make emacs with with the native compilation build
;; see https://github.com/shshkn/emacs.d/blob/master/docs/nativecomp.md
(setq comp-speed 2
