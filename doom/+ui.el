...
(after! treemacs
  (custom-set-faces!
    `(treemacs-root-face :height 1.3 :weight bold :slant normal :family "Proxima Nova" :background ,(doom-color 'bg))
    `(treemacs-directory-collapsed-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-directory-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-file-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-fringe-indicator-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-added-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-conflict-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-ignored-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-modified-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-renamed-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-unmodified-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-git-untracked-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-help-column-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-help-title-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-on-failure-pulse-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-on-success-pulse-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-tags-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    `(treemacs-term-node-face :height 0.9 :weight normal :slant normal :family "Proxima Nova")
    )
  )
