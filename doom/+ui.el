...
(custom-set-faces!
  ...
  `(lsp-lens-mouse-face :inherit shadow)
...
(custom-theme-set-faces! 'doom-spacegrey
  ...
  `(lsp-headerline-breadcrumb-symbols-face :foreground ,(doom-color 'cyan) :background "#1f242f")
  `(lsp-headerline-breadcrumb-path-hint-face :background "#1f242f")
  `(lsp-headerline-breadcrumb-path-info-face :background "#1f242f")
  `(lsp-headerline-breadcrumb-separator-face :foreground ,(doom-color 'cyan) :foreground ,(doom-color 'cyan)  :family "Avenir Next" :height 1.0)
...
(after! tree-sitter
  ...
  (custom-theme-set-faces! 'doom-ayu-mirage
    ...
    `(tree-sitter-hl-face:variable :foreground ,(doom-blend 'cyan 'white 0.8))
