;;; mogster-theme.el --- port of Bogster -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: December 4, 2022
;; Author: Matt Sawyer <https://github.com/mattsawyer77>
;; Maintainer:
;; Source: https://github.com/vv9k/bogster
;;
;;; Commentary:
;;; Code:
...
(defgroup mogster-theme nil
  "Options for mogster."
  :group 'doom-themes)

(defcustom mogster-brighter-comments t
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'mogster-theme
  :type 'boolean)

(defcustom mogster-comment-bg mogster-brighter-comments
  "If non-nil, comments will have a subtle, darker background.
Enhancing their legibility."
  :group 'mogster-theme
  :type 'boolean)

(defcustom mogster-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme mogster
  ...
  ((bg         '("#141d26" nil       nil            ))
   ...
   ;; face categories
   ;; XXX: for some reason highlight is being inherited by tree-sitter-hl-face:function.call
   (highlight      cyan)
   ...
   (-modeline-pad
    (when mogster-padded-modeline
      (if (integerp mogster-padded-modeline) mogster-padded-modeline 4)))
  ...
  ((cursor                                       :background fg)
   ...
   (mode-line-inactive                           :background bg :foreground fg
                                                 :box (if -modeline-pad `(:line-width ,-modeline-pad :color red)))
   ;;;; centaur-tabs
   (centaur-tabs-selected-modified               :inherit 'centaur-tabs-selected :foreground white)
   (centaur-tabs-unselected-modified             :inherit 'centaur-tabs-unselected :foreground white)
   (centaur-tabs-active-bar-face                 :background white)
   ...
   ;;;; ediff <built-in>
   (ediff-current-diff-Ancestor (doom-blend blue bg 0.2))
   (ediff-current-diff-A :background (doom-blend red bg 0.2))
   (ediff-current-diff-B :background (doom-blend green bg 0.2))
   (ediff-current-diff-C :background (doom-blend cyan bg 0.2))
   (ediff-even-diff-Ancestor (doom-blend blue bg 0.2))
   (ediff-even-diff-A :background (doom-blend red bg 0.2))
   (ediff-even-diff-B :background (doom-blend green bg 0.2))
   (ediff-even-diff-C :background (doom-blend cyan bg 0.2))
   (ediff-fine-diff-Ancestor (doom-blend blue bg 0.3))
   (ediff-fine-diff-A :background (doom-blend red bg 0.3))
   (ediff-fine-diff-B :background (doom-blend green bg 0.3))
   (ediff-fine-diff-C :background (doom-blend cyan bg 0.3))
   (ediff-odd-diff-Ancestor (doom-blend blue bg 0.2))
   (ediff-odd-diff-A :background (doom-blend red bg 0.2))
   (ediff-odd-diff-B :background (doom-blend green bg 0.2))
   (ediff-odd-diff-C :background (doom-blend cyan bg 0.2))
   ...
   (treemacs-git-untracked-face                 :foreground grey)
   ...
   (treemacs-root-face                          :foreground cyan)
   ;;;; web-mode
   ;; html
